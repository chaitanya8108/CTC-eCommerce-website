...
// node_modules/@clerk/shared/dist/runtime/error-74EhajFh.mjs
...
// node_modules/@clerk/shared/dist/runtime/authorization-XX4mKaAz.mjs
...
// node_modules/@clerk/clerk-react/dist/chunk-F54Q6IK5.mjs
...
// node_modules/@clerk/shared/dist/runtime/organization-D9SEGukq.mjs
...
var StripeLibsProvider = ({ children }) => {
  const clerk = useClerk();
  const { data: stripeClerkLibs } = useSWR("clerk-stripe-sdk", async () => {
  ...
  return import_react6.default.createElement(StripeLibsContext.Provider, { value: { value: stripeClerkLibs || null } }, children);
};
...
var usePaymentSourceUtils = (forResource = "user") => {
  ...
  const { data: stripe } = useSWR(stripeClerkLibs && externalGatewayId && stripePublishableKey ? {
    key: "stripe-sdk",
    externalGatewayId,
...
var PaymentElementProvider = ({ children, ...props }) => {
  return import_react6.default.createElement(StripeLibsProvider, null, import_react6.default.createElement(PropsProvider, props, import_react6.default.createElement(PaymentElementInternalRoot, null, children)));
};
...
// node_modules/@clerk/clerk-react/dist/chunk-D3WH3Z63.mjs
...
// node_modules/@clerk/shared/dist/runtime/utils-DnE51LOo.mjs
var logErrorInDevMode = (message) => {
  if (isDevelopmentEnvironment()) console.error(`Clerk: ${message}`);
};

// node_modules/@clerk/clerk-react/dist/chunk-MV5LDDHP.mjs
...
// node_modules/@clerk/shared/dist/runtime/versionSelector-DzegTfJe.mjs
var versionSelector = (clerkJSVersion, packageVersion = "5.109.1") => {
  if (clerkJSVersion) return clerkJSVersion;
  const prereleaseTag = getPrereleaseTag(packageVersion);
  if (prereleaseTag) {
    if (prereleaseTag === "snapshot") return "5.109.1";
...
// node_modules/@clerk/shared/dist/runtime/loadClerkJsScript-BctCAY1Y.mjs
